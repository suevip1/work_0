...
if [ "$COMPONENT" = "master" ] ; then
  ENTRY_POINT_CLASS='com.dtstack.engine.master.EngineApplication'
...
JAVA_OPTS="$JAVA_OPTS -Xbootclasspath/p:$basedir/ext/classes"
$JAVA_HOME/bin/java -cp "$basedir/lib/*" com.dtstack.dtcenter.loader.kerberos.AlterKrb
