...
public class QueryJobDTO {
    ...
    /** 时间结束时间范围 */
    private Long execEndTimeStart;
    private Long execEndTimeEnd;
    ...
    public Long getExecEndTimeStart() {
        return execEndTimeStart;
    }

    public void setExecEndTimeStart(Long execEndTimeStart) {
        this.execEndTimeStart = execEndTimeStart;
    }

    public Long getExecEndTimeEnd() {
        return execEndTimeEnd;
    }

    public void setExecEndTimeEnd(Long execEndTimeEnd) {
        this.execEndTimeEnd = execEndTimeEnd;
    }
}
