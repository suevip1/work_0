...
public class ScheduleJobDTO extends ScheduleJob {
    ...
    private Date execEndTimeStart;

    private Date execEndTimeEnd;
    ...
    public Date getExecEndTimeStart() {
        return execEndTimeStart;
    }

    public void setExecEndTimeStart(Date execEndTimeStart) {
        this.execEndTimeStart = execEndTimeStart;
    }

    public Date getExecEndTimeEnd() {
        return execEndTimeEnd;
    }

    public void setExecEndTimeEnd(Date execEndTimeEnd) {
