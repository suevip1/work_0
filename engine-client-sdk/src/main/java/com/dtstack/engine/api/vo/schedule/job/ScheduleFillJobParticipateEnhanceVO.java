 ...
 * @Description:
 */
public class ScheduleFillJobParticipateEnhanceVO {
     ...
     * 补数据信息
     */
    private ScheduleFillDataInfoEnhanceVO fillDataInfo;
    ...
    public Integer getCloseRetry() {
        return closeRetry;
    }

    public void setCloseRetry(Integer closeRetry) {
        this.closeRetry = closeRetry;
    }

    public ScheduleFillDataInfoEnhanceVO getFillDataInfo() {
        return fillDataInfo;
    }

    public void setFillDataInfo(ScheduleFillDataInfoEnhanceVO fillDataInfo) {
