...
public interface ScheduleTaskCommitMapper {
    ...
    List<ScheduleTaskCommit> findTaskByTaskIdAndAppType(@Param("taskId") Long taskId, @Param("appType") Integer appType, @Param("day") Integer day);

    void deleteByCommitIds(@Param("commitIds") List<String> commitIds);
}
