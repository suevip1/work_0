...
public interface TenantResourceDao {
    ...
    **/
    ...
    /**
    * @author zyd
    * @Description 根据租户id和任务类型删除
    * @Date 11:05 上午 2020/10/15
    * @Param [tenantId, dtUicTenantId]
    * @retrun java.lang.Integer
    **/
    Integer deleteByTenantIdAndTaskType(@Param("dtUicTenantId") Long dtUicTenantId, @Param("taskType") Integer taskType);
    ...
    * @retrun com.dtstack.engine.po.TenantResource
    **/
    ...
    * @Param [dtUicTenantId]
    * @retrun java.util.List<com.dtstack.engine.po.TenantResource>
    **/
