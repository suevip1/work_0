...
import com.dtstack.engine.api.vo.task.TaskInfoVO;
...
public class ScheduleTaskShadeController {
    ...
    public String addOrUpdateBatchTask(@RequestBody List<ScheduleTaskShadeDTO> batchTaskShadeDTOs, @RequestParam("commitId") String commitId) {
    ...
    public void deleteTask(@RequestParam("taskId") Long taskId, @RequestParam("modifyUserId") long modifyUserId, @RequestParam("appType") Integer appType) {
        scheduleTaskShadeService.deleteTask(taskId, modifyUserId, appType,null);
    }
    ...
    public List<ScheduleTaskShade> getTasksByName(@RequestParam("projectId") long projectId,
        ...
        return scheduleTaskShadeService.fillScheduleConf(scheduleTaskShadeService.getTasksByName(projectId, name, appType));
    }
    ...
    public ScheduleTaskShade getByName(@RequestParam("projectId") long projectId,
        ...
        return scheduleTaskShadeService.fillScheduleConf(scheduleTaskShadeService.getByName(projectId, name, appType, flowId));
    }
    ...
    public ScheduleTaskShade getBatchTaskById(@RequestParam("id") Long taskId, @RequestParam("appType") Integer appType) {
        return scheduleTaskShadeService.fillScheduleConf(scheduleTaskShadeService.getBatchTaskById(taskId, appType));
    }
    ...
    public ScheduleTaskShadePageVO queryTasks(@RequestParam("tenantId") Long tenantId,
        ...
        return scheduleTaskShadeService.queryTasks(tenantId, dtTenantId, projectId, name, ownerId, startTime, endTime, scheduleStatus, taskTypeList, periodTypeList, currentPage, pageSize, searchType, appType,resourceIds);
    }
    ...
    public List<ScheduleTaskShade> getFlowWorkSubTasks(@RequestParam("taskId") Long taskId, @RequestParam("appType") Integer appType, @RequestParam("taskTypes") List<Integer> taskTypes, @RequestParam("ownerId") Long ownerId) {
        return scheduleTaskShadeService.fillScheduleConf(scheduleTaskShadeService.getFlowWorkSubTasks(taskId, appType, taskTypes, ownerId));
    }
    ...
    public ScheduleTaskShade findTaskId(@RequestParam("taskId") Long taskId, @RequestParam("isDeleted") Integer isDeleted, @RequestParam("appType") Integer appType) {
        return scheduleTaskShadeService.fillScheduleConf(scheduleTaskShadeService.findTaskId(taskId, isDeleted, appType));
    }

    @RequestMapping(value = "/findTaskNames", method = {RequestMethod.POST})
    public List<TaskInfoVO> findTaskNames(@RequestBody List<TaskKeyVO> taskKeyVOS) {
        return scheduleTaskShadeService.findTaskNames(taskKeyVOS);
    }
    ...
    public List<ScheduleTaskShade> findTaskIds(@RequestParam("taskIds") List<Long> taskIds, @RequestParam("isDeleted") Integer isDeleted, @RequestParam("appType") Integer appType, @RequestParam("isSimple") boolean isSimple) {
        return scheduleTaskShadeService.fillScheduleConf(scheduleTaskShadeService.findTaskIds(taskIds, isDeleted, appType, isSimple));
    }
    ...
    public List<ScheduleTaskShade> getTaskByIds(@RequestParam("taskIds") List<Long> taskIds, @RequestParam("appType") Integer appType) {
        return scheduleTaskShadeService.fillScheduleConf(scheduleTaskShadeService.getTaskByIds(taskIds, appType));
    }
    ...
    public List<ScheduleTaskShadeTypeVO> findFuzzyTaskNameByCondition(@RequestParam("name") String name,
                                                                      ...
                                                                      @RequestParam("projectId") Long projectId) {
        return scheduleTaskShadeService.findFuzzyTaskNameByCondition(name,null, appType, uicTenantId, Lists.newArrayList(projectId),null,EProjectScheduleStatus.NORMAL.getStatus());
    }

    @ApiOperation(value = "模糊查询任务")
    @RequestMapping(value = "/findFuzzyTaskNameByProjectIds", method = {RequestMethod.POST})
    public List<ScheduleTaskShadeTypeVO> findFuzzyTaskNameByProjectIds(@RequestParam("name") String name,
                                                                       @RequestParam("tenantName") String tenantName,
                                                                       @RequestParam("appType") Integer appType,
                                                                       @RequestParam("uicTenantId") Long uicTenantId,
                                                                       @RequestParam("projectIds") List<Long> projectIds,
                                                                       @RequestParam("limit") Integer limit) {
        return scheduleTaskShadeService.findFuzzyTaskNameByCondition(name,tenantName, appType, uicTenantId, projectIds,limit,EProjectScheduleStatus.NORMAL.getStatus());
    }
