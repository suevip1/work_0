 ...
 **/
public class GenericDirectedCycleJudge<V, I, S extends DirectGraphSide<V, I>> implements DirectedCycleJudge<V, I, S> {

    private final List<S> sidesForJudge;

    public GenericDirectedCycleJudge(List<S> sidesForJudge) {
