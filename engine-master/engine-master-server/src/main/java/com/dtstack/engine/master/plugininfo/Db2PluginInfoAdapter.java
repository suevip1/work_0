 ...
 */
@Component
public class Db2PluginInfoAdapter extends AbstractPluginAdapter {
    ...
    protected JSONObject getSelfConfigWithTask(JSONObject clusterConfigJson) {
        ...
        return JSONObject.parseObject(clusterService.db2Info(pluginInfoContext.getDtUicTenantId(), pluginInfoContext.getDtUicUserId(), pluginInfoContext.getComponentVersionMap(), projectVO));
    }

    @Override
    public EComponentType getEComponentType() {
        return EComponentType.DB2;
    }
}
