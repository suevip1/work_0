 ...
 */
@Component
public class HanaPluginInfoAdapter extends AbstractPluginAdapter {
    ...
    protected JSONObject getSelfConfigWithTask(JSONObject clusterConfigJson) {
        ...
        return JSONObject.parseObject(clusterService.hanaInfo(pluginInfoContext.getDtUicTenantId(), pluginInfoContext.getDtUicUserId(), pluginInfoContext.getComponentVersionMap(), projectVO));
    }
