 ...
 */
@Component
public class HashDataPluginInfoAdapter extends AbstractPluginAdapter {
    ...
    protected JSONObject getSelfConfigWithTask(JSONObject clusterConfigJson) {
        ...
        return JSONObject.parseObject(clusterService.hashDataInfo(pluginInfoContext.getDtUicTenantId(), pluginInfoContext.getDtUicUserId(), pluginInfoContext.getComponentVersionMap(), projectVO));
    }
