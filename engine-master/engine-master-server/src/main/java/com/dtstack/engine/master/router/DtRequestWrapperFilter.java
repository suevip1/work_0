...
public class DtRequestWrapperFilter extends OncePerRequestFilter {
    ...
    public final static String DT_AUTH = "isAllAuth";

    private static String[] excludeTargets = {
            "/node/download/component/downloadFile", "/node/upload/component/config",
            "/node/upload/component/addOrUpdateComponent", "/node/alert/edit",
            "/node/alert/testAlert", "/node/upload/component/parseKerberos",
            "/node/upload/component/uploadKerberos", "/node/upload/component/uploadSSL","/node/notifyRecord/send",
            "/node/upload/parseCalenderExcel","/node/upload/addOrUpdateCalenderExcel",
            "/node/upload/parseGlobalParamCalenderExcel", "/node/param/addOrUpdateParam"
    };
