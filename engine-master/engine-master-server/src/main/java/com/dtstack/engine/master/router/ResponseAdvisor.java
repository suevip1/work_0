...
import com.dtstack.engine.master.config.GitContextConfig;
...
public class ResponseAdvisor implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object body,
        ...
        apiResult.setVersion(GitContextConfig.getGitBranch());
        return apiResult;
    }
    ...
    public ApiResult exceptionHandler(Throwable e) {
        ...
        if (e.getCause() instanceof RdosDefineException) {
            ...
            if (rdosDefineException.getErrorCode() != null && rdosDefineException.getErrorCode().getCode() != errorCode.getCode()) {
                errorCode = rdosDefineException.getErrorCode();
                if (Locale.SIMPLIFIED_CHINESE.getLanguage().equals(LocaleContextHolder.getLocale().getLanguage())) {
                    errorMsg = errorCode.getZhMsg();
                } else {
                    errorMsg = errorCode.getEnMsg();
                }
            } else {
                errorMsg = rdosDefineException.getErrorMsg();
            }
            ...
            errorCode = ErrorCode.HTTP_CALL_ERROR;
            errorMsg = "SDK: " + ExceptionUtil.getErrorMessage(e);
        } else {
            errorCode = ErrorCode.SERVER_EXCEPTION;
            errorMsg = !StringUtils.isBlank(e.getMessage()) ? e.getMessage() : ErrorCode.SERVER_EXCEPTION.getDescription();
            LOGGER.error("", e);
        }
