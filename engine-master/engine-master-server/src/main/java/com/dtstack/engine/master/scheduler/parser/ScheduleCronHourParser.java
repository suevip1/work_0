...
public class ScheduleCronHourParser extends ScheduleCron {
    ...
    public boolean equals(Object o) {
        ...
        ScheduleCronHourParser that = (ScheduleCronHourParser) o;
        return beginHour == that.beginHour && endHour == that.endHour && gapNum == that.gapNum && beginMinute == that.beginMinute;
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), beginHour, endHour, gapNum, beginMinute);
    }
}
