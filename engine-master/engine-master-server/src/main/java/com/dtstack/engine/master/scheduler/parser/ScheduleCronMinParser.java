...
public class ScheduleCronMinParser extends ScheduleCron {
    ...
    public boolean equals(Object o) {
        ...
        ScheduleCronMinParser that = (ScheduleCronMinParser) o;
        return beginHour == that.beginHour && endHour == that.endHour && gapNum == that.gapNum && beginMin == that.beginMin && endMin == that.endMin;
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), beginHour, endHour, gapNum, beginMin, endMin);
    }
}
