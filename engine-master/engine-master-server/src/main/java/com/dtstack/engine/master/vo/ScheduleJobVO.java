...
public class ScheduleJobVO extends com.dtstack.engine.api.vo.ScheduleJobVO {
    ...
    public ScheduleJobVO(ScheduleJob scheduleJob,String logInfo) {
        build(scheduleJob, logInfo);
    }

    private void build(ScheduleJob scheduleJob, String logInfo) {
        ...
        this.setBusinessDate(TimeUtils.getOnlyDate(scheduleJob.getBusinessDate()));
        ...
        this.setScheduleEngineJob(new ScheduleEngineJob(scheduleJob,logInfo));
