...
public class GenericDirectedGraphCycleJudgeTest {
    ...
    public void isCycle0() {
        ...
        DirectedGraphCycleJudge<String,Long, ScheduleTaskRefShadeGraphSideAdapter> judge0 =
                new GenericDirectedGraphCycleJudge<>(adapterList0);
        ...
        DirectedGraphCycleJudge<String,Long, ScheduleTaskRefShadeGraphSideAdapter> judge1 =
                new GenericDirectedGraphCycleJudge<>(adapterList1);
    ...
    public void isCycle1() {
        ...
        DirectedGraphCycleJudge<String,Long, ScheduleTaskRefShadeGraphSideAdapter> judge2 =
                new GenericDirectedGraphCycleJudge<>(adapterList2);

        DirectedGraphCycleJudge<String,Long, ScheduleTaskRefShadeGraphSideAdapter> judge3 =
                new GenericDirectedGraphCycleJudge<>(adapterList3);

        DirectedGraphCycleJudge<String,Long, ScheduleTaskRefShadeGraphSideAdapter> judge4 =
                new GenericDirectedGraphCycleJudge<>(adapterList4);
