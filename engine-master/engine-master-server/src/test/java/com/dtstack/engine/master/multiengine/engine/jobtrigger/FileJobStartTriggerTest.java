...
public class FileJobStartTriggerTest {
    FileJobStartTrigger fileJobStartTrigger =  new FileJobStartTrigger();
    ...
    public void testDtScriptHadoopJobTrigger() {
        try {
            ...
            fileJobStartTrigger.readyForTaskStartTrigger(actionParam, scheduleTaskShade, job);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static class Mock extends BaseMock {
        ...
        @MockInvoke(
                targetClass = FileCopyJobService.class,
                targetMethod = "buildFileCopyTask"
        )
        public String buildFileCopyTask(Map<String, Object> actionParam, ScheduleTaskShade taskShade,
