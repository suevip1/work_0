...
public class ComponentTestResultDTO {
     ...
     * 控制台参数校验单个结果
     */
    private List<ConsoleParamCheckResultDTO> consoleParamCheckResultList;
    ...
    public List<ConsoleParamCheckResultDTO> getConsoleParamCheckResultList() {
        return consoleParamCheckResultList;
    }

    public void setConsoleParamCheckResultList(List<ConsoleParamCheckResultDTO> consoleParamCheckResultList) {
