...
public enum RdosTaskStatus implements Serializable {
    ...
    public static RdosTaskStatus getTaskStatus(String taskStatus) {
        ...
        if (Strings.isNullOrEmpty(taskStatus)) {
            ...
            return RdosTaskStatus.WAITENGINE;
        }
    ...
    public final static List<Integer> RUNNING_STATUS = Lists.newArrayList(RUNNING.getStatus(), NOTFOUND.getStatus(), RUNNING_TASK_RULE.getStatus(), FAILING.getStatus());
    ...
    private final static Map<Integer, List<Integer>> STREAM_STATUS = new HashMap<>();
    ...
    static {
        ...
        STATUS_FAILED_DETAIL.put(CANCELED.getStatus(), Lists.newArrayList(KILLED.getStatus(), CANCELED.getStatus(),EXPIRE.getStatus(), AUTOCANCELED.getStatus()));
    ...
    public static String getShowStatusDesc(Integer status) {
        ...
        RdosTaskStatus taskStatus = RdosTaskStatus.getTaskStatus(showStatus);
        switch (taskStatus) {
            case FINISHED:
                return "成功";
            case RUNNING:
