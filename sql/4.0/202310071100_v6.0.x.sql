...
DELETE FROM schedule_dict WHERE dict_code = 'typename_mapping' AND dict_name = 'yarn3hw-hdfs3hw-flink116' AND type = 6;
...
VALUES ('typename_mapping', 'yarn3hw-hdfs3hw-flink116', '-158', null, 6, 0, 'LONG', '', 0, now(),
        now(), 0);